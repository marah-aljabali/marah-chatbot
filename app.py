...
if question:
    ...
    with st.chat_message("assistant"):
        ...
        تعليمات هامة جداً:
        1. أجب على السؤال بدقة عالية بناء على قاعدة البيانات بعد فهم سياق ومحتوى السؤال جيدًا.
        2.لا تستخدم معلومات عشوائية من مواقع ويب مختلفة، لديك صلاحية لموقع الويب الخاص بالجامعة الإسلامية فقط
        ...
        6. افهم السؤال جيدًا قبل الإجابة لأن السؤال قد يكون بلهجة عامية فلسطينية أو بالفصحى
        7. لا تأخذ المعنى الحرفي للكلام، قد يختلف سؤالين في الصيغة لكن لهم نفس المعنى
